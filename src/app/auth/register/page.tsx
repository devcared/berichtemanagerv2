          ...
          <form onSubmit={handleRegister} className="flex flex-col gap-5">
            <div className="flex flex-col gap-2">
              ...
              <input
                ...
                className="w-full px-4 py-3 rounded-xl border border-border bg-input focus:bg-background focus:ring-2 focus:ring-primary/10 focus:border-primary outline-none text-[0.9375rem] transition-all duration-200 placeholder:text-muted-foreground/40 shadow-none"
              />
            </div>

            <div className="flex flex-col gap-2">
              <label htmlFor="password" className="text-[0.8125rem] font-bold text-foreground/85 ml-1">Passwort</label>
              <input
            ...
            <div className="flex flex-col gap-2">
              <label htmlFor="confirmPassword" className="text-[0.8125rem] font-bold text-foreground/85 ml-1">Passwort bestätigen</label>
              <input
                id="confirmPassword" type="password" required
                placeholder="••••••••"
                value={confirmPassword} onChange={e => setConfirmPassword(e.target.value)}
                className={`w-full px-4 py-3 rounded-xl border bg-input focus:bg-background focus:ring-2 outline-none text-[0.9375rem] transition-all duration-200 placeholder:text-muted-foreground/40 shadow-none ${
            ...
            {successMsg && (
              <div className="p-4 bg-green-500/10 border border-green-500/20 rounded-xl text-green-600 dark:text-green-400 text-[0.875rem] text-center font-semibold animate-in fade-in zoom-in-95">
                {successMsg}
              </div>
            )}
            ...
            <button
              ...
              className="mt-4 w-full py-3.5 bg-primary hover:bg-primary/90 text-primary-foreground rounded-xl text-[1rem] font-bold transition-all duration-300 disabled:opacity-70 disabled:cursor-not-allowed flex items-center justify-center gap-3 shadow-none active:scale-[0.985] group"
            >
              {isLoading ? (
                <>
